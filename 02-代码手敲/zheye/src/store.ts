...
// export { testData, testPosts, ColumnProps, PostProps };
...
const store = createStore<GlobalDataProps>({
  state: {
    columns: testData,
    posts: testPosts,
    user: { isLogin: false, nickName: "viking", columnId: 1 },
  },
...
// console.log(store.state.count, "store");
// store.commit("add");
// console.log(store.state.count, "store1");
